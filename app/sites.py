...
FONTS = [
    ...
    # Cyrillic-capable faces for the Russian side. Bricolage, Anton, Fraunces
    # and Instrument Serif ship no Cyrillic, so the Russian pages cannot simply
    # reuse the English pairings - the headings would silently fall back to a
    # system font and every Russian page would look the same.
    "Unbounded:wght@400;700;800",
    "Onest:wght@400;500;700;800",
    "Golos+Text:wght@400;500;600",
    "Bitter:wght@400;600;700",
...
PAGES: dict[str, dict[str, Any]] = {
    ...
    "ru-agency": {
        ...
        "theme": {
            ...
            "display_tracking": "-.03em",
            "display_transform": "none",
            # Unbounded runs about twice Anton's width per character, and the
            # stacked layout's size was set against Anton.
            "h1_scale": ".58",
            "body": "Onest",
        },
        "layout": "stacked",
        "nav": ["Услуги", "Цены", "Отчётность", "Контакты"],
        "hero": {
            "eyebrow": "Перформанс-маркетинг · Екатеринбург",
            "title": "Меньше слить. Больше продать. Знать почему.",
            "lead": "Яндекс.Директ, VK Реклама, Telegram Ads и SEO для компаний с "
                    "оборотом от 5 до 300 млн в год. Девять человек, пятнадцать "
                    "клиентов, без субподряда.",
            "cta": "Записаться на разбор",
            "cta2": "Посмотреть цены",
        },
        "stats": [
            ("12%", "от бюджета, без наценки на медиа"),
            ("15", "клиентов, и это потолок"),
            ("15", "рабочих дней до первых правок"),
            ("110 000 ₽", "аудит с фиксированной ценой"),
        ],
        "sections": [
            {
                "kicker": "Что ведём",
                "title": "Четыре канала, но по-настоящему",
                "intro": "Лучше вести четыре канала хорошо, чем восемь кое-как. "
                         "Всё живёт внутри ваших рекламных кабинетов, а не наших.",
                "items": [
                    ("Контекст", "Яндекс.Директ",
                     "Структура, ставки, фиды и работа с минус-словами, которую "
                     "пропускают все, потому что она скучная."),
                    ("Таргет", "VK Реклама · Telegram Ads",
                     "Тестируем креативы под гипотезу, а не двенадцать вариантов "
                     "одной и той же картинки."),
                    ("SEO", "Техническое и контентное",
                     "Шесть-девять месяцев до внятного результата. Кто обещает "
                     "быстрее — вам что-то продаёт."),
                    ("Рассылки", "Unisender · Sendsay",
                     "То, ради чего платный трафик окупается со второго касания, "
                     "а не с первого."),
                ],
            },
            {
                "kicker": "Сколько стоит",
                "title": "Цена, которую можно посчитать заранее",
                "intro": "Берём только за ведение. Бюджет вы пополняете сами, "
                         "напрямую в кабинетах — мы к нему не притрагиваемся.",
                "items": [
                    ("Платный трафик", "12% от бюджета, минимум 60 000 ₽",
                     "При бюджете меньше 500 000 ₽ процент теряет смысл, и мы "
                     "считаем фиксированную сумму."),
                    ("SEO", "от 80 000 ₽ в месяц",
                     "Техника, контент и ссылки, с отчётом по выручке, а не по "
                     "позициям в выдаче."),
                    ("Аудит отдельно", "110 000 ₽ фиксированно",
                     "Три недели, документ остаётся у вас, продолжать с нами вы "
                     "не обязаны. Примерно половина остаётся."),
                ],
            },
        ],
        "band": {
            "title": "Скажем сразу, если не сможем помочь",
            "body": "При бюджете меньше 200 000 ₽ в месяц вам выгоднее специалист "
                    "внутри команды. Мы говорим это на первом созвоне, а не после "
                    "третьего счёта.",
            "cta": "Занять 30 минут",
        },
        "footer": "«Полдень» · Екатеринбург, ул. Малышева, 51 · hello@polden.example",
    },
    ...
    "ru-shop": {
        ...
        "layout": "panel",
        "nav": ["Каталог", "Доставка", "Возврат", "Опт"],
        "hero": {
            "eyebrow": "Одежда из льна · шьём в Иванове",
            "title": "Небольшие партии, натуральные ткани, честные замеры.",
            "lead": "На карточке стоят реальные сантиметры изделия, а не "
                    "абстрактные S–M–L. Поэтому по размеру у нас возвращают реже, "
                    "чем в среднем по рынку.",
            "cta": "Спросить про размер",
            "cta2": "Условия доставки",
        },
        "stats": [
            ("900", "заказов в месяц"),
            ("до 15:00", "заказ уедет сегодня"),
            ("14 дней", "на возврат без объяснений"),
            ("от 6 000 ₽", "доставка бесплатно"),
        ],
        "sections": [
            {
                "kicker": "Доставка",
                "title": "Куда, за сколько и когда",
                "intro": "Заказ до 15:00 по Москве уезжает в тот же рабочий день.",
                "items": [
                    ("СДЭК до пункта", "350 ₽ · 2–5 дней",
                     "Самый частый выбор. Трек приходит на почту и в Telegram "
                     "сразу, как только сформирована накладная."),
                    ("Курьером до двери", "550 ₽ · 4–7 дней",
                     "По Москве и Иванову есть курьер в день отправки — 400 ₽."),
                    ("Казахстан", "от 1 200 ₽ · 8–14 дней",
                     "Только СДЭК. Таможенные платежи, если они возникнут, "
                     "оплачивает получатель."),
                ],
            },
            {
                "kicker": "Возврат",
                "title": "Четырнадцать дней и без разговоров",
                "intro": "Причину объяснять не нужно. Деньги возвращаем на ту же "
                         "карту за пять рабочих дней.",
                "items": [
                    ("Обмен размера", "Бесплатно, один раз на заказ",
                     "Обратную доставку берём на себя, готовую накладную пришлём "
                     "прямо в чат."),
                    ("Брак и пересорт", "Обратная доставка за наш счёт",
                     "Пришлите фото — заменим сразу, возвращать вещь обычно даже "
                     "не нужно."),
                    ("Что не примем", "Индивидуальный пошив",
                     "Бельё и вещи по вашим меркам, как того требует закон. "
                     "Предупреждаем об этом до оплаты."),
                ],
            },
        ],
        "band": {
            "title": "Не уверены в размере — не заказывайте два",
            "body": "Напишите рост, обхват груди и талии, и мы подскажем. Это "
                    "быстрее, дешевле и честнее, чем оформлять возврат.",
            "cta": "Подобрать размер",
        },
        "footer": "«Лоскут» · Иваново, ул. Красной Армии, 12 · help@loskut.example",
    },
    ...
    "ru-school": {
        ...
        "layout": "split",
        "nav": ["Программы", "Как учим", "Цены", "Потоки"],
        "hero": {
            "eyebrow": "Онлайн-школа для новых руководителей",
            "title": "Вас повысили за работу. Теперь работа — это люди.",
            "lead": "«Ступень» помогает перейти из исполнителя в руководителя, не "
                    "делая вид, что это просто. Три преподавателя, все — "
                    "действующие тимлиды.",
            "cta": "Записаться на консультацию",
            "cta2": "Посмотреть программы",
        },
        "stats": [
            ("49 000 ₽", "базовый курс «Основа»"),
            ("8 недель", "два вебинара в неделю"),
            ("20", "человек в потоке, не больше"),
            ("13%", "вернём налоговым вычетом"),
        ],
        "sections": [
            {
                "kicker": "Программы",
                "title": "Три способа зайти",
                "intro": "Рассрочка без переплаты на 3, 6 или 12 месяцев через "
                         "Тинькофф. Первый платёж через месяц.",
                "items": [
                    ("«Основа»", "49 000 ₽ · 8 недель",
                     "Два вебинара в неделю по 90 минут, домашние задания с "
                     "письменным разбором, закрытый чат потока."),
                    ("«Практика»", "89 000 ₽ · 12 недель",
                     "Разбор ваших рабочих ситуаций в группах по пять человек и "
                     "две личные встречи с преподавателем."),
                    ("Индивидуально", "8 000 ₽ за встречу",
                     "Раз в две недели по 50 минут, под конкретную ситуацию, а не "
                     "под общее развитие."),
                ],
            },
            {
                ...
                "intro": "Это дешевле выяснить до оплаты, чем на третьей неделе.",
                "items": [
                    ("Не подготовка к собеседованиям", "Посоветуем других",
                     "Резюме и интервью — другое ремесло, и его делают лучше "
                     "другие люди."),
                    ("Не терапия", "Другая дисциплина",
                     "Если мешает не работа, коучинг — неподходящий инструмент, и "
                     "мы об этом скажем."),
                    ("Не пассивно", "Работать придётся вам",
                     "Кто ничего не делает между занятиями, получает мало. Мы "
                     "говорим это до оплаты."),
                ],
            },
        ],
        "band": {
            "title": "Первая консультация — разговор, а не продажа",
            "body": "Тридцать минут бесплатно, и примерно один разговор из четырёх "
                    "заканчивается тем, что курс вам сейчас не нужен. Это хороший "
                    "исход, а не потерянная заявка.",
            "cta": "Выбрать время",
        },
        "footer": "«Ступень» · онлайн, занятия по московскому времени · hello@stupen.example",
    },
}
